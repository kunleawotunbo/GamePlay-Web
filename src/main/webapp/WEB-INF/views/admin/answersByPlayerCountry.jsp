<%-- 
    Document   : answersByPlayerCountry
    Created on : 26-Sep-2017, 11:11:34
    Author     : BELLO
--%>
        ...
        <div class="row">
            ...
            <!--              <div class="col-md-6 col-sm-12 col-xs-12">--> 
             <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Search Matches Played By Player's Country</h2> 
                       ...
                       <form:form modelAttribute="matchPrediction" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left" id="addWeeklyGame-form" data-parsley-validate="">  
                            <form:hidden path="id" id="id" name="id" />
                             ...
                             <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-3">Player's Country<span class="required">*</span></label>
                                    <div class="col-sm-4">                                         
                                        <form:select id="countryCode" path="countryCode" title="Choose Player Country To Search" class="form-control">
